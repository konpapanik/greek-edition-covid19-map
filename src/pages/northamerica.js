...
const FourthPage = () => {
  ...
  return (
    <Layout pageName="home">
      <Helmet>
        <title>US and CANADA COVID-19 Interactive Map live Update - Virus near by</title>
      </Helmet>

      <Map {...mapSettings} />

      <Container type="content" className="text-center home-start">
        <h2>Virus near by στη Βόρια Αμερική| Live update των COVID-19 περιστατικών στην Αμερική</h2>
        <p>Το VirusNearBy βρίσκει τα περιστατικά ιών στην Αμερική βάσει των επίσημων πηγών που συνδέονται με δεδομένα</p>
        <pre>
